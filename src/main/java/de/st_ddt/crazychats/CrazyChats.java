...
import de.st_ddt.crazyutil.modules.permissiongroups.PermissionCrazyChatsSystem;
...
public final class CrazyChats extends CrazyPlayerDataPlugin<ChatPlayerData, ChatPlayerData>
{
	...
	static
	{
		PermissionModule.registerFallbackPermissionSystem(PermissionCrazyChatsSystem.class);
	}
	...
	private void registerCommands()
	{
		...
		playerCommand.addSubCommand(new CommandPlayerListName(this), "listname", "lname");
		playerCommand.addSubCommand(new CommandPlayerSilence(this), "silence", "globalmute");
		playerCommand.addSubCommand(new CommandPlayerMute(this), "mute");
		playerCommand.addSubCommand(new CommandPlayerUnmute(this), "unmute");
		playerCommand.addSubCommand(new CommandPlayerSearch(this), "s", "search");
