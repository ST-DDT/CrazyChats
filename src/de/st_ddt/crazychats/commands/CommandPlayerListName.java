...
public class CommandPlayerListName extends CommandExecutor
{
	...
	public void command(final CommandSender sender, final String[] args) throws CrazyException
	{
		...
		if (!sender.hasPermission("crazychats.player.listname." + (player != null && player.equals(sender) ? "self" : "other")))
	...
	{
		return sender.hasPermission("crazychats.player.listname.self") || sender.hasPermission("crazychats.player.listname.other");
	}
}
